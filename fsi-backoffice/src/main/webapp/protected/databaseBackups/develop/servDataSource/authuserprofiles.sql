...
<profile id="legal" typecode="PFL" typedescr="Default user profile"><descr /><groups /><categories /><attributes><attribute name="fullname" attributetype="Monotext"><monotext>Tommy Legal</monotext></attribute><attribute name="email" attributetype="Monotext"><monotext>t.legal@gmail.com</monotext></attribute></attributes></profile>
',0);
